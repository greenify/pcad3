    ...
    constructor: function (options) {
     /* Your constructor code here
       ...
       go to section 6.3.2 in the spec. doc. */
        ...
        // no longer done by default by BioJS
        jQuery.extend(this.opt,options);
        this.opt.target = this.opt.el;
  ...
  /* Your own ‘PUBLIC’ methods  */
    ...
    _set_points: function (){
        ...
        .enter().append("path")
          ...
          .on("click", function(d){self.trigger('pointClick', { data_object:d });})
...
Events.mixin(PCAD3.prototype);
module.exports = PCAD3;
